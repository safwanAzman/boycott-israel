      ...
      <div>
        <div className="bg-gray-100/80 dark:bg-gray-900/80 backdrop-blur-xl p-4 sticky top-14 rounded-l-lg z-40">
          ...
          <div className="px-6">
            <div
              ref={scrollRef}
              className="flex snap-x flex-shrink-0  space-x-1.5 overflow-x-auto no-scrollbar"
            >
              ...
              {filteredData.map((item) => {
                ...
                return (
                  <BoycottCard
                    key={item.id}
                    img={item.img_url}
                    href={`/why/${item.id}/${suburl}?categories=${selectedCategory}`}
