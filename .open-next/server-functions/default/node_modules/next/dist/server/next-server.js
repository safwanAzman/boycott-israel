...
class NextNodeServer extends _baseserver.default {
    constructor(options){
        ...
        super(options), this.cleanupListeners = new _asynccallbackset.AsyncCallbackSet(), this.handleNextImageRequest = async (req, res, parsedUrl) => false, this.handleCatchallRenderRequest = async (req, res, parsedUrl)=>{
  ...
  throw new Error("runMiddleware should not be called with OpenNext");
    ...
    getPrerenderManifest() {
        ...
        this._cachedPreviewManifest = (0, _loadmanifestexternal.loadManifest)((0, _path.join)(this.distDir, _constants.PRERENDER_MANIFEST));
        return this._cachedPreviewManifest;
    }
    getRoutesManifest() {
